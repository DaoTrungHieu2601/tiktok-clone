...
const Header = () => {
    ...
    return (
        <div className="w-full h-[60px] shadow-[0px_1px_1px_rgba(0,0,0,0.12)] flex justify-center">
            <div className="h-full w-[1150px] flex items-center justify-between">
                ...
                <Tippy
                    ...
                    render={attrs => (
                        <div className="w-[361px]" tabIndex="-1" {...attrs}>
                            <Wrapper>
                                <h4 className="search-title text-[rgba(22,24,35,0.5)] text-[1rem] font-semibold">
                                    Accounts
                                </h4>
                                <AccountItem />
                                <AccountItem />
